...
public class ArmourDesign {
	...
	public float getWeight() { return armourWeight; }
	public float getRating() { return baseProtection; }
	public float[] getProtectiveTraits() { return new float[] {cuttingModifier, bluntModifier, piercingModifier}; }
	public float getBulk() { return bulk; }
	...
	public String getGroup() { return weightGroup; }
}
